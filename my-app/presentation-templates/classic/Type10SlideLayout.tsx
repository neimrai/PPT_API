...
export const layoutDescription =
  "A chart-focused layout with title, chart visualization, and description text.";
...
const chartDataSchema = z.object({
  ...
  category: z
    .string()
    .optional()
    .meta({ description: "Category for grouping" }),
  x: z
    .number()
    .optional()
    .meta({ description: "X coordinate for scatter plots" }),
  y: z
    .number()
    .optional()
    .meta({ description: "Y coordinate for scatter plots" }),
});
...
const type10SlideSchema = z.object({
  ...
  description: z
    ...
    .min(8)
    .max(40)
    .default("This is a description of the chart analysis")
    .meta({
...
const Type10SlideLayout: React.FC<Type10SlideLayoutProps> = ({
  data: slideData,
}) => {
  const {
    title,
  ...
  return (
    <div className=" rounded-sm w-full max-w-[1280px] px-3 py-[10px] sm:px-12 lg:px-20 sm:py-[40px] lg:py-[86px] shadow-lg max-h-[720px] flex flex-col items-center justify-center aspect-video bg-white relative z-20 mx-auto">
